...
class MiscellaneousUtilsTest {
    ...
    fun getOrDefault() {
        ...
        /*try {
            t = Callable<String> { throw Exception("This should be re-tossed as an Error") }.getOrThrow(DurianConsumer { throw Error("Something Fatal", it) })
            ...
            if (e.cause!!.message != "This should be re-tossed as an Error") throw AssertionError("Expected Exception \"This should be re-tossed as an Error\"", e)
        }*/
        ...
        /*t = Callable<String> { "Exceptionally" }.getOrThrow(DurianConsumer { throw AssertionError("This shouldn't occur", it) })
