...
public class PingCommand extends AbstractCommand {
    ...
    public void run(Message msg, String args){
        ...
        channel.triggerTypingIndicator().thenAcceptAsync(v -> {
            ...
            sm.latency((int)s).thenAcceptAsync(hb -> {
                if(MiscellaneousUtils.canEmbed(msg)) channel.sendMessage(MiscellaneousUtils.genBaseEmbed(0x46AF2C, null, msg.guild(), "\uD83C\uDFD3 Pong!", null, MiscellaneousUtils.now())
    ...
    @Override public String toDescription(Message msg){
        return "Pings the current channel.";
    }

    @Override public String[] toCategories(){
